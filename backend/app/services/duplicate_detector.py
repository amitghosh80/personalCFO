...
def file_already_imported(session: Session, user_id: int, source_file_hash: str) -> bool:
...
def existing_job_for_file(session: Session, user_id: int, source_file_hash: str) -> str | None:
